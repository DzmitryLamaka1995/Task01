...
public class Task4 {
	...
	public static void main(String[] args) {
		// 4. ƒана последовательность натуральных чисел а1 , а2 ,..., ап. —оздать массив
		...
		int temp = 0;
		createMas(array);
		System.out.println("—озданный массив :");
		printMas(array);
		...
		if (temp == 0) {
			System.out.println("¬ данном массиве нет четных чисел");
			return;
		}
		...
		System.out.println();
		System.out.println("ћассив из четных чисел :");
